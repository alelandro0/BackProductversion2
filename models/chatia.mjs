...
export const START_CHAT = [
  {
    ...
    parts: `Nombre de la Empresa: Multiservicios
        ...
        Andrea: Andrea es una pintora y enfermera con 13 años de experiencia, que ofrece servicios de alta calidad. Su experiencia y dedicación garantizan un excelente nivel de servicio, numero de telefono 1234567890
        ...
        Dar agradecimiento diciendo: espero que mi informacion te sirbar de ayuda
        ...
        Los creadores de multiservicios: esta conformado por Alejandro Giraldo, Juan David Torres, Daniela Sanchez y
         Alejandro Osorio 
        `,
